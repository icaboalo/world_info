...
import diana.com.worldinfo.io.model.AutoCompleteResponse;
...
public interface ApiService {
    ...
    void searchCityDetails(@Query(ApiConstants.ARG_FQCN)String city, Callback<> cityDetailsApiResponse);
